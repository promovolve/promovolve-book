...
**タケシの旅館** (Travel, Hiking): 予算残高あり？ はい ($20)。キャンペーンはアクティブ？ はい。このサイトでクリエイティブは承認済み？ はい。入札: **$5.00 CPM**。

**JR Rail Pass** (Travel): 予算残高あり？ はい。入札: **$8.00 CPM**。

**Hiking Gear Co** (Hiking): 予算残高あり？ はい。入札: **$4.00 CPM**。
